...
# 读取数据
with open(f'./samples/ad-cpu3.csv', newline='') as f:
    reader = csv.reader(f)
...
y_true = [0]*20+[1]*54+[0]*28+[1]*63+[0]*17+[1]*66+[0]*15+[1]*66+[0]*293
...
print("Recall:", rec)
print("F1 score:", f1)
output.append(",".join(["DeepSVDD", prec, rec, f1, roc_auc]))

with open(f"./results/result-total", "w") as c:
